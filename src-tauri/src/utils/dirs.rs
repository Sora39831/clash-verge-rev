...
pub static APP_ID: &str = "io.github.cloudxp.clash-verge-cloudxp";
#[cfg(not(feature = "verge-dev"))]
pub static BACKUP_DIR: &str = "clash-verge-cloudxp-backup";

#[cfg(feature = "verge-dev")]
pub static APP_ID: &str = "io.github.cloudxp.clash-verge-cloudxp.dev";
#[cfg(feature = "verge-dev")]
pub static BACKUP_DIR: &str = "clash-verge-cloudxp-backup-dev";
...
mod ipc_tests {
    ...
    fn sidecar_ipc_stays_in_the_app_root() {
        ...
        let app_root = Path::new("/home/test/.local/share/io.github.cloudxp.clash-verge-cloudxp");
...
mod ipc_tests {
    ...
    fn sidecar_ipc_ignores_long_app_root_and_fits_sockaddr_un() -> anyhow::Result<()> {
        let identity = OwnerIdentity::Unix { uid: 501, gid: 20 };
        let app_root =
            Path::new("/Users/support/Library/Application Support/io.github.cloudxp.clash-verge-cloudxp.dev");
        let path = sidecar_ipc_path_for(app_root, &identity)?;
