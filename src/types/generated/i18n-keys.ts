...
export const translationKeys = [
  ...
  'auth.login.actions.submitting',
  'auth.login.errors.missingFields',
  'auth.login.feedback.importSuccess',
  'auth.login.feedback.importFailed',
  'auth.login.feedback.logoutSuccess',
  'auth.login.feedback.tokenReset',
  'auth.login.feedback.subscriptionRejected',
  'auth.account.title',
  'auth.account.email',
  'auth.account.logout',
  'auth.account.confirmLogout',
